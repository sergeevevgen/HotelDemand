...
conclusion3 = 'Смотря результаты моделей, нельзя однозначно сделать вывод, какая лучше. У одной оценки лучше по ' \
              'одной метрике, у другой модели - по другим метрикам. Нейронная сеть справилась лучше,' \
              ' чем гребневая регрессия. Регрессию следует доработать. В нашем случае' \
              ' следует выбрать нейронную сеть, так как она выдает более точные результаты'
